...
export declare class Pair {
    ...
    constructor(currencyAmountA: CurrencyAmount<Token>, tokenAmountB: CurrencyAmount<Token>, factoryAddress: string, initCodeHash: string, symbol?: string, name?: string);
    /**
