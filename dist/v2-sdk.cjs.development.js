...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB, factoryAddress, initCodeHash, symbol, name) {
    if (symbol === void 0) {
      symbol = 'UNI-V2';
    }
    ...
    this.liquidityToken = new sdkCore.Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency, factoryAddress, initCodeHash), 18, symbol, name);
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    return [outputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.factoryAddress, this.initCodeHash, this.symbol, this.name)];
  };
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    return [inputAmount, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.factoryAddress, this.initCodeHash, this.symbol, this.name)];
  };
