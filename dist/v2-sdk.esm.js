...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB, factoryAddress, initCodeHash, symbol, name) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency, factoryAddress, initCodeHash), 18, symbol, name);
